...
export default function Page() {
  ...
  return (
    <div className="flex h-full w-96 max-w-full flex-col px-1 md:w-[1008px]">
      ...
      <section className="templateSection flex w-full flex-col items-center justify-center gap-4 rounded-xl bg-[#ffed00]px-2 py-4 md:grow">
        <div className="flex h-[450px] w-[450px] max-w-full items-center justify-center rounded-xl bg-[#ffed00]">
